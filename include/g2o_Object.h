...
class cuboid{
  public:
	  ...
	  Eigen::Vector4d rotate_errors_norm; Eigen::Vector4d rotate_angles(-1,0,1,2); // rotate -90 0 90 180
      ...
      {
      	Eigen::Matrix3Xd corners_body;corners_body.resize(3,8);
	  ...
	  Eigen::Vector4d projectOntoImageRect(const SE3Quat& campose_cw, const Eigen::Matrix3d& Kalib) const
      {
		  ...
		  Eigen::Matrix2Xd corner_2d = homo_to_real_coord<double>(Kalib*homo_to_real_coord<double>(campose_cw.to_homogeneous_matrix()*real_to_homo_coord<double>(corners_3d_world)));
